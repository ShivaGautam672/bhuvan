...
const rpcEndpoint = "https://sepolia.infura.io/v3/f36325de133e45b0a69e8235959f6505"; // Replace with your custom testnet RPC endpoint
const infuraUrl = rpcEndpoint;

const App = () => {
  const [sidesl, setsidesl] = useState("Token");
  const standard_adr = "0xFFd785f51b2236a2D51833FE36984DcF74d73E2c";
      ...
      {!account ? (
        <div className="container">
           <div class="image-container">
              <img src="https://images.rawpixel.com/image_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIyLTA1L3B4MTU4NDgwMy1pbWFnZS1rd3Z4dmxjai5qcGc.jpg" alt="Background Image"/>
           </div>
